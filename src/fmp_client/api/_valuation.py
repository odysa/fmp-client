...
class ValuationMixin:
    ...
    async def custom_discounted_cash_flow(self, symbol: str) -> JSONArray:
    ...
    async def custom_levered_discounted_cash_flow(self, symbol: str) -> JSONArray:
    ...
    async def enterprise_values(self, symbol: str) -> JSONArray:
